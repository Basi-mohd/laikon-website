// React + TailwindCSS + TypeScript Product Page
...
const batterySeries = [
    {
        name: 'CL BATTERY',
        image: clBattery, // Replace with your image path
        details: [
            {
                type: 'IT 160',
                capacity: '160 AH',
    ...
    {
        name: 'EL BATTERY',
        image: elBattery, // Replace with your image path
        details: [
            {
                type: 'IT 160',
                capacity: '160 AH',
    ...
    {
        name: 'SL BATTERY',
        image: slBattery, // Replace with your image path
        details: [
            {
                type: 'IT 160',
                capacity: '160 AH',
